...
public class UpdateBindPhoneActivity extends BaseActivity {
    ...
    protected void initView() {
        super.initView();
        bindPasswordBar.setStyle("验证当前手机", Color.parseColor("#f8d948"));
...
//                BaseActivity.navigate(BindPhoneActivity.this, UpdatePassActivity.class);
    ...
    private void bindPhone() {
        ...
        OkGo.<String>post(ServiceApi.revisePhoneNumber)
                ...
                .params("oldPhoneNumber", bindPasswordEdit.getText().toString())
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (result == 1) {
                                ...
                                bundle.putString("oldPhoneNumber", phoneNumber);
                                BaseActivity.navigate(UpdateBindPhoneActivity.this, UpdateNewBindPhoneActivity.class, bundle);
                                finish();
                            } else if (result == 0) {
