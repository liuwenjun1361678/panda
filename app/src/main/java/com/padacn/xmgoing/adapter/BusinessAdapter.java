...
public class BusinessAdapter extends BaseQuickAdapter<BusinessDetailsBean.DataBean.ProductsBean, BaseViewHolder> {
    private TextView[] textViews = new TextView[3];

    public BusinessAdapter(int layoutResId, @Nullable List<BusinessDetailsBean.DataBean.ProductsBean> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseViewHolder helper, BusinessDetailsBean.DataBean.ProductsBean item) {
