...
public class HomeThreeAdapter extends BaseQuickAdapter<ListActivityModel, BaseViewHolder> {


    public HomeThreeAdapter(int layoutResId, @Nullable List<ListActivityModel> data) {
