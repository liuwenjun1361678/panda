...
public class ShopCarAdapter extends BaseExpandableListAdapter {
    ...
    public ShopCarAdapter(Context context, ListView listView, List<CartInfo.DataBean> list) {
        super();
    ...
    public int getChildrenCount(int i) {
        return (list != null && list.size() > 0) ? list.get(i).getItems().size() : 0;
    }
...
//        new FrontViewToMove(viewHolder1.frontView, listView,200);
        ...
        CommonUtil.loadImage(context, list.get(groupPosition).getItems().get(position).getImage(), viewHolder1.zqRoundOvalImageView);
