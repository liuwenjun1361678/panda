...
public class StrategdetailAdapter extends BaseQuickAdapter<StrategDetailBean.DataBean.RandStrategyBean, BaseViewHolder> {

    public StrategdetailAdapter(int layoutResId, @Nullable List<StrategDetailBean.DataBean.RandStrategyBean> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseViewHolder helper, StrategDetailBean.DataBean.RandStrategyBean item) {
