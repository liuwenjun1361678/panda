...
public class StrategiesAdapter extends BaseQuickAdapter<StrategyBean.DataBean.ListStrategyBean, BaseViewHolder> {


    public StrategiesAdapter(int layoutResId, @Nullable List<StrategyBean.DataBean.ListStrategyBean> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseViewHolder helper, StrategyBean.DataBean.ListStrategyBean item) {
        ...
        Log.d(TAG, "convert: " + item.getPics().size());
