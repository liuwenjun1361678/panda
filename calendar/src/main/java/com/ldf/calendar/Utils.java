...
public final class Utils {
    ...
    //获取当前年份
    public static int getCurrYear(String data) {
    ...
    //获取当前年份
    public static int getCurrMonth(String data) {
        SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd");
        Date date = null;
        Calendar calendar = null;
        try {
    ...
    //获取当前年份yyyy-MM
    public static int getCurrMonthX(String data) {
    ...
    //获取当前月份yyyy-MM
    public static int getCurrMonthY(String data) {
        SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM");
        Date date = null;
        Calendar calendar = null;
        try {
    ...
    //获取当前年份
    public static int getCurrDay(String data) {
        SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd");
        Date date = null;
        Calendar calendar = null;
        try {
     ...
     * @return
     */
    public static long getAppointTime(String timeString) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = null;
        try {
            date = format.parse(timeString);
